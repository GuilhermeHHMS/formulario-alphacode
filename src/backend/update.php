...
if (isset($dadosRecebidos['nomeContato']) && isset($dadosRecebidos['dataNascimento']) &&
    ...
    $sql = "UPDATE alpha_table SET nomeContato='$nomeContato', dataNascimento='$dataNascimento', email='$email', profissao='$profissao', telefoneContato='$telefoneContato', celularContato='$celularContato' WHERE id='$id'";
